...
%% Results
disp('                            ')
disp('%%%%%%%%%%%%%%%%%%% Invasive Weed Optimization Results with capacitor sizing & placement %%%%%%%%%%%%%%%%%%%%%%%%%%')
disp('------------------------------------------------------')
...
disp('------------------------------------------------------')
disp('                            ')
disp('%%%%%%%%%%%%%%%%%%% Invasive Weed Optimization System Results %%%%%%%%%%%%%%%%%%%%%%%%%%')
disp('------------------------------------------------------')
